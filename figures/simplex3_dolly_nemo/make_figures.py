#!/usr/bin/env python
"""The simplex3 cross-level closer for Mistral-Nemo-Instruct-2407 on databricks-dolly-15k.
...
Usage
-----
    python figures/simplex3_dolly_nemo/make_figures.py
    python figures/simplex3_dolly_nemo/make_figures.py --level structural --level behavioral
"""
...
def main() -> None:
    ...
    suite.run_suite(
        ...
        datasets=DATASETS,
        source="figures/simplex3_dolly_nemo/make_figures.py",
    )
