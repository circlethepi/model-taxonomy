#!/usr/bin/env python
"""The simplex3 cross-level closer for OLMo-2-0425-1B-Instruct on databricks-dolly-15k.
...
Usage
-----
    python figures/simplex3_dolly_olmo2/make_figures.py
    python figures/simplex3_dolly_olmo2/make_figures.py --level structural --level behavioral
"""
...
def main() -> None:
    ...
    suite.run_suite(
        ...
        datasets=DATASETS,
        source="figures/simplex3_dolly_olmo2/make_figures.py",
    )
