#!/usr/bin/env python
"""The simplex3 cross-level closer for Llama-3.1-8B-Instruct on oasst1 best-reply pairs.
...
Usage
-----
    python figures/simplex3_oasst1_llama3i/make_figures.py
    python figures/simplex3_oasst1_llama3i/make_figures.py --level structural --level behavioral
"""
