#!/usr/bin/env python
"""The simplex3 cross-level closer for OLMo-2-0425-1B-Instruct on oasst1 best-reply pairs.
...
Usage
-----
    python figures/simplex3_oasst1_olmo2/make_figures.py
    python figures/simplex3_oasst1_olmo2/make_figures.py --level structural --level behavioral
"""
...
#: `03_adapters/allenai--OLMo-2-0425-1B-Instruct` holds every adapter trained on this base model
...
def main() -> None:
    ...
    suite.run_suite(
        ...
        datasets=DATASETS,
        source="figures/simplex3_oasst1_olmo2/make_figures.py",
    )
