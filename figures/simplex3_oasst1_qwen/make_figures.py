#!/usr/bin/env python
"""The simplex3 cross-level closer for Qwen3.5-4B on oasst1 best-reply pairs.
...
Usage
-----
    python figures/simplex3_oasst1_qwen/make_figures.py
    python figures/simplex3_oasst1_qwen/make_figures.py --level structural --level behavioral
"""
...
def main() -> None:
    ...
    suite.run_suite(
        ...
        datasets=DATASETS,
        source="figures/simplex3_oasst1_qwen/make_figures.py",
    )
