#!/bin/bash
#SBATCH --job-name=yahoo_behavioral_reextract_s00
...
python scripts/run_experiment.py /weka/scratch/cpriebe1/MO/model-taxonomy/experiments/yahoo_behavioral_smoke.yaml --steps build extract
