...
#SBATCH --job-name=s3_embed_s09
#SBATCH --partition=nvl,h100,l40s,a100
#SBATCH --gres=gpu:1
#SBATCH --mem=48G
#SBATCH --cpus-per-task=8
#SBATCH --time=2:00:00
#SBATCH --output=/weka/scratch/cpriebe1/MO/model-taxonomy/results/simplex3/logs/s3_embed_s09-%j.out
...
python scripts/run_experiment.py experiments/simplex3/sweep_s09.yaml --steps build extract --taxonomy dataset_embedding
