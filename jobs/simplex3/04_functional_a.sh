...
#SBATCH --job-name=s3_func_a
#SBATCH --partition=nvl,h100,l40s,a100
#SBATCH --gres=gpu:1
#SBATCH --mem=64G
#SBATCH --cpus-per-task=8
#SBATCH --time=2:00:00
#SBATCH --output=/weka/scratch/cpriebe1/MO/model-taxonomy/results/simplex3/logs/s3_func_a-%j.out
...
python scripts/run_experiment.py experiments/simplex3/functional_a.yaml --steps build extract --taxonomy functional
