...
#SBATCH --job-name=s3_behav_b0
#SBATCH --partition=nvl,h100,l40s,a100
#SBATCH --gres=gpu:1
#SBATCH --mem=64G
#SBATCH --cpus-per-task=8
#SBATCH --time=1:30:00
#SBATCH --output=/weka/scratch/cpriebe1/MO/model-taxonomy/results/simplex3/logs/s3_behav_b0-%j.out
...
python scripts/run_experiment.py experiments/simplex3/behavioral_b_shard0.yaml --steps build extract --taxonomy behavioral
