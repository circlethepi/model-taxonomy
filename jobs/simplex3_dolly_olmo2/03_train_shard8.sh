...
#SBATCH --job-name=s3do2_train8
#SBATCH --partition=h200,h100,l40s,a100
#SBATCH --gres=gpu:1
#SBATCH --mem=80G
#SBATCH --cpus-per-task=8
#SBATCH --time=2:00:00
#SBATCH --output=/weka/scratch/jhu/cpriebe1/MO/model-taxonomy/results/simplex3_dolly_olmo2/logs/s3do2_train8-%j.out
...
python scripts/run_experiment.py experiments/simplex3_dolly_olmo2/train_shard8.yaml --steps build finetune
