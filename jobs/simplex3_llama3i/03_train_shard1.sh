...
#SBATCH --job-name=s3li_train1
#SBATCH --partition=h200,h100,l40s,a100
#SBATCH --gres=gpu:1
#SBATCH --mem=80G
#SBATCH --cpus-per-task=8
#SBATCH --time=2:00:00
#SBATCH --output=/weka/scratch/jhu/cpriebe1/MO/model-taxonomy/results/simplex3_llama3i/logs/s3li_train1-%j.out
...
python scripts/run_experiment.py experiments/simplex3_llama3i/train_shard1.yaml --steps build finetune
