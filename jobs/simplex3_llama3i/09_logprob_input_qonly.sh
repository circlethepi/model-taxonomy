...
#SBATCH --job-name=s3li_lp_input
#SBATCH --partition=h200,h100,l40s,a100
#SBATCH --gres=gpu:1
#SBATCH --mem=64G
#SBATCH --cpus-per-task=8
#SBATCH --time=1:00:00
#SBATCH --output=/weka/scratch/jhu/cpriebe1/MO/model-taxonomy/results/simplex3_llama3i/logs/s3li_lp_input-%j.out
...
python scripts/run_experiment.py experiments/simplex3_llama3i/logprob_input_qonly.yaml --steps build extract --taxonomy logprob
