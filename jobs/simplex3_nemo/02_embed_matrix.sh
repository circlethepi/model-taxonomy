...
#SBATCH --job-name=s3nm_embed_matrix
#SBATCH --partition=h200,h100,l40s,a100
#SBATCH --gres=gpu:1
#SBATCH --mem=48G
#SBATCH --cpus-per-task=8
#SBATCH --time=2:00:00
#SBATCH --output=/weka/scratch/jhu/cpriebe1/MO/model-taxonomy/results/simplex3_nemo/logs/s3nm_embed_matrix-%j.out
...
python scripts/run_experiment.py experiments/simplex3_nemo/embed_matrix.yaml --steps build extract --taxonomy dataset_embedding
