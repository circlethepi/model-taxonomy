...
#SBATCH --job-name=s3nm_behav_qonly0
#SBATCH --partition=h200,h100,l40s,a100
#SBATCH --gres=gpu:1
#SBATCH --mem=96G
#SBATCH --cpus-per-task=8
#SBATCH --time=2:30:00
#SBATCH --output=/weka/scratch/jhu/cpriebe1/MO/model-taxonomy/results/simplex3_nemo/logs/s3nm_behav_qonly0-%j.out
...
python scripts/run_experiment.py experiments/simplex3_nemo/behavioral_qonly_shard0.yaml --steps build extract --taxonomy behavioral
