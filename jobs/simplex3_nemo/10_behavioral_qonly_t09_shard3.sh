...
#SBATCH --job-name=s3nm_behav_qonly_t09_3
#SBATCH --partition=h200,h100,l40s,a100
#SBATCH --gres=gpu:1
#SBATCH --mem=96G
#SBATCH --cpus-per-task=8
#SBATCH --time=2:30:00
#SBATCH --output=/weka/scratch/jhu/cpriebe1/MO/model-taxonomy/results/simplex3_nemo/logs/s3nm_behav_qonly_t09_3-%j.out
...
python scripts/run_experiment.py experiments/simplex3_nemo/behavioral_qonly_t09_shard3.yaml --steps build extract --taxonomy behavioral
