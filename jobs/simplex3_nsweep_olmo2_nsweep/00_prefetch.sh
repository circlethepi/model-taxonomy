...
#SBATCH --job-name=s3no2_prefetch
#SBATCH --partition=med
#SBATCH --mem=32G
#SBATCH --cpus-per-task=8
#SBATCH --time=1:00:00
#SBATCH --output=/weka/scratch/jhu/cpriebe1/MO/model-taxonomy/results/simplex3_nsweep_olmo2_nsweep/logs/s3no2_prefetch-%j.out
