...
#SBATCH --job-name=s3no2_func_qonly
...
python scripts/run_experiment.py experiments/simplex3_nsweep_olmo2_nsweep/functional_qonly.yaml --steps build extract --taxonomy functional
