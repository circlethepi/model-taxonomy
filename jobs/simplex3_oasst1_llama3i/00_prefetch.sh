...
#SBATCH --job-name=s3oli_prefetch
#SBATCH --partition=med
#SBATCH --mem=32G
#SBATCH --cpus-per-task=8
#SBATCH --time=1:00:00
#SBATCH --output=/weka/scratch/jhu/cpriebe1/MO/model-taxonomy/results/simplex3_oasst1_llama3i/logs/s3oli_prefetch-%j.out
...
p = snapshot_download('meta-llama/Llama-3.1-8B-Instruct', allow_patterns=['*.json','*.safetensors','*.model','tokenizer*','*.jinja','merges.txt'])
print('cached at', p)
"
