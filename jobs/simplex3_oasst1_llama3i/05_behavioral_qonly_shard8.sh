...
#SBATCH --job-name=s3oli_behav_qonly8
#SBATCH --partition=h200,h100,l40s,a100
#SBATCH --gres=gpu:1
#SBATCH --mem=64G
#SBATCH --cpus-per-task=8
#SBATCH --time=1:30:00
#SBATCH --output=/weka/scratch/jhu/cpriebe1/MO/model-taxonomy/results/simplex3_oasst1_llama3i/logs/s3oli_behav_qonly8-%j.out
...
python scripts/run_experiment.py experiments/simplex3_oasst1_llama3i/behavioral_qonly_shard8.yaml --steps build extract --taxonomy behavioral
