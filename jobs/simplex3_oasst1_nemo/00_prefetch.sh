...
#SBATCH --job-name=s3onm_prefetch
#SBATCH --partition=med
#SBATCH --mem=32G
#SBATCH --cpus-per-task=8
#SBATCH --time=1:00:00
#SBATCH --output=/weka/scratch/jhu/cpriebe1/MO/model-taxonomy/results/simplex3_oasst1_nemo/logs/s3onm_prefetch-%j.out
...
p = snapshot_download('mistralai/Mistral-Nemo-Instruct-2407', allow_patterns=['*.json','*.safetensors','*.model','tokenizer*','*.jinja','merges.txt'], ignore_patterns=['consolidated.safetensors'])
print('cached at', p)
"
