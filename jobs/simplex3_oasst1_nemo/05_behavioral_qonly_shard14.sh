...
#SBATCH --job-name=s3onm_behav_qonly14
#SBATCH --partition=h200,h100,l40s,a100
#SBATCH --gres=gpu:1
#SBATCH --mem=96G
#SBATCH --cpus-per-task=8
#SBATCH --time=2:30:00
#SBATCH --output=/weka/scratch/jhu/cpriebe1/MO/model-taxonomy/results/simplex3_oasst1_nemo/logs/s3onm_behav_qonly14-%j.out
...
python scripts/run_experiment.py experiments/simplex3_oasst1_nemo/behavioral_qonly_shard14.yaml --steps build extract --taxonomy behavioral
