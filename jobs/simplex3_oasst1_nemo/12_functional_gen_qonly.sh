...
#SBATCH --job-name=s3onm_func_gen_qonly
#SBATCH --partition=h200,h100,l40s,a100
#SBATCH --gres=gpu:1
#SBATCH --mem=96G
#SBATCH --cpus-per-task=8
#SBATCH --time=4:00:00
#SBATCH --output=/weka/scratch/jhu/cpriebe1/MO/model-taxonomy/results/simplex3_oasst1_nemo/logs/s3onm_func_gen_qonly-%j.out
...
python scripts/run_experiment.py experiments/simplex3_oasst1_nemo/functional_gen_qonly.yaml --steps build extract --taxonomy functional
