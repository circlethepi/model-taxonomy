...
#SBATCH --job-name=s3oo2_func_qonly
#SBATCH --partition=h200,h100,l40s,a100
#SBATCH --gres=gpu:1
#SBATCH --mem=64G
#SBATCH --cpus-per-task=8
#SBATCH --time=2:00:00
#SBATCH --output=/weka/scratch/jhu/cpriebe1/MO/model-taxonomy/results/simplex3_oasst1_olmo2/logs/s3oo2_func_qonly-%j.out
...
python scripts/run_experiment.py experiments/simplex3_oasst1_olmo2/functional_qonly.yaml --steps build extract --taxonomy functional
