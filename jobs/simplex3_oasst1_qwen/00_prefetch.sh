...
#SBATCH --job-name=s3oq_prefetch
#SBATCH --partition=med
#SBATCH --mem=32G
#SBATCH --cpus-per-task=8
#SBATCH --time=1:00:00
#SBATCH --output=/weka/scratch/jhu/cpriebe1/MO/model-taxonomy/results/simplex3_oasst1_qwen/logs/s3oq_prefetch-%j.out
...
p = snapshot_download('Qwen/Qwen3.5-4B', allow_patterns=['*.json','*.safetensors','*.model','tokenizer*','*.jinja','merges.txt'])
print('cached at', p)
"
