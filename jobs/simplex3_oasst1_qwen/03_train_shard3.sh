...
#SBATCH --job-name=s3oq_train3
#SBATCH --partition=h100,h200,a100,l40s
#SBATCH --gres=gpu:1
#SBATCH --mem=96G
#SBATCH --cpus-per-task=8
#SBATCH --time=3:00:00
#SBATCH --output=/weka/scratch/jhu/cpriebe1/MO/model-taxonomy/results/simplex3_oasst1_qwen/logs/s3oq_train3-%j.out
...
python scripts/run_experiment.py experiments/simplex3_oasst1_qwen/train_shard3.yaml --steps build finetune
