...
#SBATCH --job-name=s3oq_behav_qonly9
#SBATCH --partition=h100,h200,a100,l40s
#SBATCH --gres=gpu:1
#SBATCH --mem=96G
#SBATCH --cpus-per-task=8
#SBATCH --time=2:30:00
#SBATCH --output=/weka/scratch/jhu/cpriebe1/MO/model-taxonomy/results/simplex3_oasst1_qwen/logs/s3oq_behav_qonly9-%j.out
...
python scripts/run_experiment.py experiments/simplex3_oasst1_qwen/behavioral_qonly_shard9.yaml --steps build extract --taxonomy behavioral
