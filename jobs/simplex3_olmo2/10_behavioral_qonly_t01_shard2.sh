...
#SBATCH --job-name=s3o2_behav_qonly_t01_2
#SBATCH --partition=h200,h100,l40s,a100
#SBATCH --gres=gpu:1
#SBATCH --mem=64G
#SBATCH --cpus-per-task=8
#SBATCH --time=1:30:00
#SBATCH --output=/weka/scratch/jhu/cpriebe1/MO/model-taxonomy/results/simplex3_olmo2/logs/s3o2_behav_qonly_t01_2-%j.out
...
python scripts/run_experiment.py experiments/simplex3_olmo2/behavioral_qonly_t01_shard2.yaml --steps build extract --taxonomy behavioral
