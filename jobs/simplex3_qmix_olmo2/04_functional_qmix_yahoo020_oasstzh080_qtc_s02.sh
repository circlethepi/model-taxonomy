...
#SBATCH --job-name=s3qm_func_o020_s02
#SBATCH --partition=h200,h100,l40s,a100
#SBATCH --gres=gpu:1
#SBATCH --mem=64G
#SBATCH --cpus-per-task=8
#SBATCH --time=2:00:00
#SBATCH --output=/weka/scratch/jhu/cpriebe1/MO/model-taxonomy/results/simplex3_qmix_olmo2/logs/s3qm_func_o020_s02-%j.out
...
python scripts/run_experiment.py experiments/simplex3_qmix_olmo2/functional_qmix_yahoo020_oasstzh080_qtc_s02.yaml --steps build extract --taxonomy functional
