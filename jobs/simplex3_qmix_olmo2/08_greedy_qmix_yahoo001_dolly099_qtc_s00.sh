...
#SBATCH --job-name=s3qm_greedy_d001_s00
#SBATCH --partition=h200,h100,l40s,a100
#SBATCH --gres=gpu:1
#SBATCH --mem=64G
#SBATCH --cpus-per-task=8
#SBATCH --time=1:30:00
#SBATCH --output=/weka/scratch/jhu/cpriebe1/MO/model-taxonomy/results/simplex3_qmix_olmo2/logs/s3qm_greedy_d001_s00-%j.out
...
python scripts/run_experiment.py experiments/simplex3_qmix_olmo2/greedy_qmix_yahoo001_dolly099_qtc_s00.yaml --steps build extract --taxonomy behavioral
