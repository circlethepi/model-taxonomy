...
#SBATCH --job-name=s3q_embed_matrix
#SBATCH --partition=h100,h200,a100,l40s
#SBATCH --gres=gpu:1
#SBATCH --mem=48G
#SBATCH --cpus-per-task=8
#SBATCH --time=2:00:00
#SBATCH --output=/weka/scratch/jhu/cpriebe1/MO/model-taxonomy/results/simplex3_qwen/logs/s3q_embed_matrix-%j.out
...
python scripts/run_experiment.py experiments/simplex3_qwen/embed_matrix.yaml --steps build extract --taxonomy dataset_embedding
