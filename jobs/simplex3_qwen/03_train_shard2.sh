...
#SBATCH --job-name=s3q_train2
#SBATCH --partition=h100,h200,a100,l40s
#SBATCH --gres=gpu:1
#SBATCH --mem=96G
#SBATCH --cpus-per-task=8
#SBATCH --time=3:00:00
#SBATCH --output=/weka/scratch/jhu/cpriebe1/MO/model-taxonomy/results/simplex3_qwen/logs/s3q_train2-%j.out
...
python scripts/run_experiment.py experiments/simplex3_qwen/train_shard2.yaml --steps build finetune
