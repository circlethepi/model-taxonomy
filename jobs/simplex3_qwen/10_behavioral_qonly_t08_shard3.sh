...
#SBATCH --job-name=s3q_behav_qonly_t08_3
#SBATCH --partition=h100,h200,a100,l40s
#SBATCH --gres=gpu:1
#SBATCH --mem=96G
#SBATCH --cpus-per-task=8
#SBATCH --time=2:30:00
#SBATCH --output=/weka/scratch/jhu/cpriebe1/MO/model-taxonomy/results/simplex3_qwen/logs/s3q_behav_qonly_t08_3-%j.out
...
python scripts/run_experiment.py experiments/simplex3_qwen/behavioral_qonly_t08_shard3.yaml --steps build extract --taxonomy behavioral
