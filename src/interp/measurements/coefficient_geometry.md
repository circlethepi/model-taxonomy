...
Measured over **16 adapters**, including the 3 corner adapters.

> Worth knowing when reading these: a corner adapter fitted against the corner basis returns itself exactly, so 3 of the 16 points are perfect by construction and sit on the simplex's vertices. They pin the arrangement and flatter both scores. Re-run with `--mixtures-only` for the 13-mixture configuration, where every point is a genuine fit.

## Full results

| coefficients | disparity | disparity (no MDS) | PROTEST p | dCor | dCor p | MDS stress | worst model |
|---|---|---|---|---|---|---|---|
| `ols_normalized` | 0.00637 | 0.00638 | 0.0001 | 0.9902 | 0.0001 | 7.32e-05 | `000g1_075g2_025g3` (0.0302) |
| `simplex` | 0.03262 | 0.03258 | 0.0001 | 0.9841 | 0.0001 | 8.15e-05 | `025g1_075g2_000g3` (0.0719) |
